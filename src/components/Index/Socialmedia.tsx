...
const Socialmedia = () => {
    return (
        <div>
            ...
            <a target="_blank" className="w-[130px] flex" href="https://twitter.com/chenelias5/">
                <li className="flex hover:underline hover:underline-offset-8 items-center text-purple-500 font-bold">
            ...
            <a
                target="_blank"
                className="w-[125px] flex"
                href="https://www.facebook.com/people/Elias-Chen/100074943037854/"
            >
                <li className="flex hover:underline hover:underline-offset-8 items-center text-purple-500 font-bold">
            ...
            <a target="_blank" className="w-[165px] flex" href="https://www.instagram.com/codechen9810/">
                <li className="flex hover:underline hover:underline-offset-8 items-center text-purple-500 font-bold">
